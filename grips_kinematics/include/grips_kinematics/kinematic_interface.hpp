#ifndef __GRIPS_KINEMATICS_KINEMATICS_INTERFACE_H
#define __GRIPS_KINEMATICS_KINEMATICS_INTERFACE_H
...
namespace grips_kinematics
{
  ...
  typedef boost::shared_ptr<grips_kinematics::KinematicInterface> KinematicInterfacePtr;
  typedef boost::shared_ptr<const grips_kinematics::KinematicInterface> KinematicInterfaceConstPtr;
